module.exports.STATE_RESPONSES = {
    ...
    SceneNotFound:"I couldn't the scene you requested",
    SceneStarted:"Scene $Szenename started",
    RoomNotFound:"I couldn't find $Room in the system",
    NoShuttersInRoom:"I couldn't find any blinds in $Room.",
    ...
    Percent:"Percent",
    Humidity:"Humidity",
    NoSensorFound:"I couldn't find any sensor in $Room!",
    SensorState:"The $SensorTyp value in $Room is $value $Unit.",
    SensorStateMinMax:"The $SensorTyp value in $Room is between $value1 $Unit and $value2 $Unit. The avarage value is $value3 $Unit.",
    ...
    NewStateShuttersInRoom:"Shutters in $Room set.",
    ...
    NoLightsFoundInRoom:"I couldn't find any lights in $Room.",
    NoLightsFoundInRoomAndRoom2:"I couldn't find any lights in $Room1 and $Room2.",
    DimValueIncorrect:"Dim value is incorrect. Please try again",
    DimLight:"Lights dimmed to $value percent.",
    TemperatureSet:"Thermostat in $Room set to $value degrees.",
    ...
    NoThermostatFound:"No thermostat in the room $Room couldn't be find.",
    ...
    Colors:"Colors",
    MovementInRoom:"Movement in the $Room detected.",
    NoMovementInRoom:"No movement in the $Room detected.",
